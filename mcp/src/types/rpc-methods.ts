...
import type {
  ...
  ContinueParams,
  StepInParams, StepOverParams, StepOutParams,
...
export const LaunchRequest = new rpc.RequestType<LaunchParams, LaunchResult, void>("launch");
export const AttachRequest = new rpc.RequestType<AttachParams, AttachResult, void>("attach");
...
export const StoppedNotification = new rpc.NotificationType<StoppedParams>("stopped");
export const ExitedNotification = new rpc.NotificationType<ExitedParams>("exited");
export const OutputNotification = new rpc.NotificationType<OutputParams>("output");
